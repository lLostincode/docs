...
<ParamField path="recursion_limit" type="integer" default="5-25 (env-controlled)">
  ...
  - Range: `AGENT_ITERATION_LOWER_LIMIT` (default 5) to `AGENT_ITERATION_UPPER_LIMIT` (default 25)
</ParamField>
