...
<CardGroup cols={2}>
  ...
  <Card title="UKnow" icon="cloud" href="/documentation/knowledge-base/uknow-cloud-storage">
    **Cloud Storage** ✅
...
<CardGroup cols={2}>
  <Card title="Milvus Setup" icon="database" href="/documentation/knowledge-base/milvus">
    Configure vector database knowledge bases
  </Card>
  
  <Card title="UKnow Setup" icon="cloud" href="/documentation/knowledge-base/uknow-cloud-storage">
    Connect cloud storage accounts
  </Card>
  
  <Card title="Agent Configuration" icon="gear" href="/documentation/yaml-configuration">
