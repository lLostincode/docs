...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Agent Workflows" icon="diagram-project" href="/documentation/multi-agent-workflows">
    Build complex agent systems with multiple interconnected agents
  </Card>
  
  <Card title="Monitoring & Analytics" icon="chart-line" href="/documentation/monitoring-analytics">
