...
Milvus is a production-ready vector database that enables semantic search over your documents using dense vector embeddings. Knowledge bases support customizable chunking strategies, embedding models, and structured data processing.
...
- `split_by`: `"word"` | `"char"` | `"sentence"` | `"token"`
