...
<CardGroup cols={2}>
  ...
  <Card title="Tool Integration" icon="wrench" href="/tools">
    Add tools and function calling to agents
  </Card>
  <Card title="Architecture Patterns" icon="diagram-project" href="/architecture">
