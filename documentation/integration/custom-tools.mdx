...
The Model Context Protocol (MCP) integration allows Artaios Agents to connect to external MCP servers and use their
...
6. You'll be redirected back to Artaios with an active connection
