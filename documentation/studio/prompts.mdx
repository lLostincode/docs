...
<Frame>
  ![Prompts Library](/screens/prompts_library.png)
</Frame>
...
<Frame>
  ![Prompt Categories](/screens/prompt_category.png)
</Frame>
...
<Frame>
  ![Prompts Panel](/screens/prompts_panel.png)
</Frame>
...
<Steps>
  <Step title="Create a Category">
    ...
    <Frame>
      ![Prompt Category](/screens/prompt_category.png)
    </Frame>
...
Once you've created prompts, insert them into agents:

1. Select the prompt from your library
2. Click **Insert to Playground**
3. The prompt opens in the Playground ready to use
