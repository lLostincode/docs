...
<Frame>
  ![Chunking Configuration](/images/chunking_configuration.png)
</Frame>
...
- **Split by**: word, character, sentence, or token

**Smart Extraction (Coming Soon):**

<Frame>
  ![Smart Extraction Feature](/images/smart_extraction.png)
</Frame>

<Note>
AI-powered entity extraction is currently in development. When released, it will automatically extract entities (PERSON, ORGANIZATION, CONCEPT, etc.) and metadata for enhanced retrieval accuracy. This feature uses BAML for structured extraction.
</Note>
...
<Frame>
  ![Structured Data Configuration](/images/structured_data_config.png)
</Frame>
  ...
  - name: "support_agent"
    ...
    knowledge_bases:
      - name: "product_docs"
        ...
        retrieval_config:
          strategy: "dense"  # dense, hybrid, or bm25
          top_k: 10
          search_ef: 64
          metric_type: "COSINE"
```
  ...
  - name: "advanced_agent"
    ...
    knowledge_bases:
      - name: "company_kb"
        ...
        retrieval_config:
          # Search strategy
          strategy: "hybrid"  # Options: dense, hybrid, bm25
          ...
          query_model: "gpt-4o-mini"  # LLM for generating alternative phrasings
