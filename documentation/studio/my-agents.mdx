...
**Settings**: Access version management, access control, statistics, and general settings
...
<Frame>
  ![Access Control Settings](/images/access_control.png)
</Frame>
...
**Show in Artaios**
- When enabled, agent appears in the Artaios frontend interface
- Works alongside company sharing

<Info>
**Access Summary:**
- **AMAS**: Shows your agents + shared company agents
- **Artaios**: Shows agents with "Show in Artaios" enabled
