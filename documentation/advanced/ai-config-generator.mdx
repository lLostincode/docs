...
description: "Create agent configurations in seconds by describing what you want in plain English"
---

The AI Config Generator creates complete YAML configurations from your plain English descriptions. No need to memorize YAML syntax or configuration options—just describe what you want your agent to do.
...
<Steps>
  ...
  <Step title="Describe Your Agent">
    ...
    <Frame>
      ![Config Generator Modal](/screens/config_generator.png)
    </Frame>
    ...
    For example:
    ```
    Create a customer support system that reads incoming support tickets and 
    extracts the customer name, issue category, and urgency level. Then route 
  ...
  <Step title="Generate">
    ...
    <Frame>
      ![Generated YAML Config](/screens/generated_config.png)
    </Frame>
  </Step>
...
**Data Extraction**
```
Extract name, email, phone number, and years of experience from resumes
```
