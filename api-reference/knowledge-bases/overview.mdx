...
- **Vector Processing Engine**: Milvus-backed ingestion and retrieval
...
**Milvus** is the `processing_engine` used for knowledge bases:
...
<ResponseField name="datasource_count" type="integer">
  Number of underlying datasources/files included in the knowledge base (there is no separate `collection_count` field)
</ResponseField>
