...
<ParamField path="type" type="string" required>
  ...
  See [Type Notation Reference](/guides/advanced/reference/type-notation) for all supported types.
...
|-------|-------|----------|
| `Invalid type notation` | Unsupported type syntax | Check [Type Notation Reference](/guides/advanced/reference/type-notation) |
