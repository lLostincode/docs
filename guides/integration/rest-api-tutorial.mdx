...
<Note>
Streaming is available via WebSocket connections. See the [Chatbot Integration](/guides/integration/chatbot-integration) guide for WebSocket examples.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Chatbot Integration" icon="comments" href="/guides/integration/chatbot-integration">
