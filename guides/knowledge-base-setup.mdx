...
<Note>
`uknow` is also a supported `knowledge_base_type`, used for knowledge bases backed by connected cloud-storage sources rather than a directly-managed vector index. It isn't documented in depth here yet. Additional vector database integrations will be supported in future releases.
</Note>
